// Make canvas pinch zoom and pannable
...
//Alternative to above, only set certain defaults each time
if (localStorage.getItem('pattern') == (null || '' || undefined)) {localStorage.setItem('pattern', 'retro')};
...
document.getElementById('backToLaunchpadBtn').addEventListener('click', (event) => {
